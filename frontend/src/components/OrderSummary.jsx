    ...
    >
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          {savings > 0 && (
            <dl className="flex items-center justify-between gap-4">
              ...
              <dd className="text-base font-medium text-amber-400">
                -${formattedSavings}
              </dd>
            </dl>
          )}
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm font-medium text-amber-400 underline hover:text-amber-300 hover:no-underline"
          >
            Continue Shopping
            <MoveRight size={16} />
          </Link>
